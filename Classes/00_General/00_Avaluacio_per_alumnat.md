...
|---|---|---|
| **R1 · Codi** | Programació | Funciona, està ordenat en funcions, es llegeix bé i **el saps depurar i explicar**. |
...
- Abans de preguntar a una IA: **DEPURA primer**. Protegeix el teu múscul de resoldre problemes.
- Semàfor complet d'usos permesos: [`00_IA_a_la_materia.md`](00_IA_a_la_materia.md) §5 (i el pòster de l'aula).
