...
- **Mini-checks individuals:** [`00_Mini_checks_individuals.md`](00_Mini_checks_individuals.md) — un micro-repte de codi de **10' en solitari** per SA (SA2–SA8), amb semàfor de correcció i accions de reforç. No qualifica: és el radar que detecta l'*efecte passatger* del treball en parella —qui va tirant amagat darrere del company que escriu el codi— abans de la prova trimestral.
