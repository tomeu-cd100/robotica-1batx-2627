...
## Tasca 1 · «El teu quadern tècnic» (setmana 1, un sol cop)
...
## Tasca 2 · «Quadern tècnic — SAx» (una per SA, en acabar-la)
...
**Títol:** `📓 Quadern tècnic — SA_ · [títol de la SA]`
...
## Rúbrica per a Classroom (R4 aplicada al quadern)

Tres criteris de la **R4** (la «Defensa oral» s'avalua al producte, no aquí). Punts per nivell: **10 / 8 / 6 / 4** (coherents amb les bandes Excel·lent 9-10 · Notable 7-8 · Suficient/Bé 5-6 · Insuficient 0-4).

| Criteri (10 pt) | Excel·lent (10) | Notable (8) | Suficient/Bé (6) | Insuficient (4) |
|---|---|---|---|---|
| **Quadern tècnic** (completesa) | Exhaustiu i reflexiu: els 6 apartats amb evidències (fotos, captures) i errors documentats amb DEPURA. | Complet i ordenat: tots els apartats fets amb contingut real. | Bàsic: hi és el mínim, apartats poc desenvolupats o algun de buit. | Incomplet: falten apartats o s'ha fet tot l'últim dia. |
| **Claredat tècnica** | Rigorós, precís i ben argumentat: s'entenen les decisions i el perquè. | Clar i rigorós. | Comprensible amb llacunes. | Confús o copiat sense elaborar. |
| **Terminologia** | Precisa i professional. | Adequada. | Bàsica. | Incorrecta o absent. |

> Per introduir-la: a la tasca → **Rúbrica → Crea una rúbrica** → 3 criteris, 4 nivells cadascun amb els punts i descriptors de la taula. A partir de la segona SA: **Torna a fer servir la rúbrica** → tria la de la SA anterior.
