...
> 💻 **On programo?** Canvi de llenguatge altre cop: **micro:bit amb MicroPython**, a l'editor **<https://python.microbit.org>** (com a la SA5; té simulador). Només l'opció **ESP32** (demo del docent i repte ⭐⭐⭐) va amb l'editor d'Arduino. Detalls i alternatives: [connexions i entorn](SA8_connexions.md).
