...
> ✍️ **Katas:** en acabar el modelatge de cada sessió amb pràctica de codi, projecta el kata de la pràctica del dia ([SA8_katas.md](SA8_katas.md)): 10' d'escriptura individual **abans** de repartir/obrir el sketch.
