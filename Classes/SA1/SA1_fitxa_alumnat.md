...
Etiqueta a l'**esquema mut** (`SA1_esquemes_connexions.md`, 1.2): microcontrolador · pins digitals · pins analògics (A0–A5) · alimentació (5V, GND) · USB · PWM (~).
...
Llegeix `SA1_normes_seguretat.md` i **signa** el full. Les 2 normes que et semblen més importants:
...
Tria un **robot real** i analitza'l amb `SA1_poster_robot_plantilla.md` (entrada-procés-sortida + dilema ètic). S'avalua amb la rúbrica **R4**.
